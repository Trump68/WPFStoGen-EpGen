...
namespace StoGenMake.Scenes.Base
{
    public class Fools_Art_Homare : BaseScene
    {
        ...
        internal static void LoadDataAndAlign(List<seIm> data, List<AlignDif> alignData, string path)
        {
            ...
            // Mouth
            src = $"MouthSensual_1710084001"; fn = $"MOUTH_01.png";
            ...
            GetIm(src, VNPCPersType.Manga, dsc, path, fn, data, new DifData() { sX = 100, sY = 100, Flip = 0 });
            src = $"LADY_Mouth_1710140003"; fn = $"MOUTH_07.png";
            GetIm(src, VNPCPersType.Manga, dsc, path, fn, data, new DifData() { sX = 100, sY = 100, Flip = 0 });
            src = $"LADY_Mouth_1710140004"; fn = $"MOUTH_08.png";
            GetIm(src, VNPCPersType.Manga, dsc, path, fn, data, new DifData() { sX = 100, sY = 100, Flip = 0 });
            ...
            SetCadre(new AlignData[] { new AlignData("MouthSensual_1710084001", src, new DifData() { X = 344, Y = 307, sX = 58, sY = 58, Rot = 272, Flip = 1 }) });
            ...
            GetIm(src, VNPCPersType.Manga, dsc, path, fn, data, new DifData() { X = 100, Y = 100, sX = 500, sY = 500, Flip = 0 });
            SetCadre(new AlignData[] { new AlignData("MouthSensual_1710084001", src, new DifData() { X = 247, Y = 225, sX = 58, sY = 58, Rot = 265, Flip = 1 }) });

            src = $"LADY_Head_1710110003"; fn = $"006_head.png";
            GetIm(src, VNPCPersType.Manga, dsc, path, fn, data, new DifData() { X = 100, Y = 100, sX = 500, sY = 500, Flip = 0 });
            SetCadre(new AlignData[] { new AlignData("MouthSensual_1710084001", src, new DifData() { X = 247, Y = 225, sX = 58, sY = 58, Rot = 265, Flip = 1 }) });

            src = $"LADY_Head_1710110004"; fn = $"007a_head.png";
            GetIm(src, VNPCPersType.Manga, dsc, path, fn, data, new DifData() { X = 100, Y = 100, sX = 500, sY = 500, Flip = 0 });
            SetHeadAlign1(src, data, alignData, path);

            src = $"LADY_Head_1710110005"; fn = $"007b_head.png";
            GetIm(src, VNPCPersType.Manga, dsc, path, fn, data, new DifData() { X = 100, Y = 100, sX = 500, sY = 500, Flip = 0 });
            SetHeadAlign1(src, data, alignData, path);

            src = $"LADY_Head_1710110006"; fn = $"007c_head.png";
            GetIm(src, VNPCPersType.Manga, dsc, path, fn, data, new DifData() { X = 100, Y = 100, sX = 500, sY = 500, Flip = 0 });
            SetHeadAlign1(src, data, alignData, path);

            src = $"LADY_Head_1710110007"; fn = $"008_head.png";
            GetIm(src, VNPCPersType.Manga, dsc, path, fn, data, new DifData() { X = 100, Y = 100, sX = 500, sY = 500, Flip = 0 });
            SetCadre(new AlignData[] { new AlignData("MouthSensual_1710084001", src, new DifData() { X = 267, Y = 335, sX = 65, sY = 65, Rot = 280, Flip = 1 }) });
            // Body

            #region Posing legs parted
            src = $"Body_PosingLegsParted_1710083003"; fn = $"003.png";
        ...
        private static void SetHeadAlign1(string src, List<seIm> data, List<AlignDif> alignData, string path)
        {
