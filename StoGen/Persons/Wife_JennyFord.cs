...
namespace StoGenerator.Persons
{
    public class Wife_JennyFord : Person //Kazoku ~Haha To Shimai No Kyousei~
    {
        ...
        internal List<Info_Scene> ResetTransitions(List<Info_Scene> posture)
        {
            List<Info_Scene> result = new List<Info_Scene>();
        ...
        internal void AddBlink(List<Info_Scene> posture, Poses pose, Eyes eyes)
        {
            ...
            if (v != null)
            {
                ...
                v.T = Transitions.Eyes_Blink;
                v.O = "0";
                v.Z = (posture.Count()+1).ToString();
                posture.Add(v);
            }
        }
...
// New +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        {         
            ...
            posture = SetFeature(posture, pose.ToString(), Eyes.EyesClosed1.ToString(), Eyes.EyesGeneric.ToString(), Transitions.Dissapearing(1000));
            posture = SetFeature(posture, pose.ToString(), Mouth.MouthOpen2.ToString(), Mouth.MouthGeneric.ToString(), Transitions.Dissapearing(1000));
            return posture;
        }
