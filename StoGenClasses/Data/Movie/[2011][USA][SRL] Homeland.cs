...
namespace StoGen.Classes.Data.Movie
{
    public class _2011_USA_SRL_Homeland : BaseScene
    {
        ...
        private void Scene1()
        {
            ...
            AC(file, new AP() { APS = 000.15, APE = 007.10 });//fuck
            AC(file, new AP() { APS = 000.15, APE = 035.30 });//fuck
            AC(file, new AP() { APS = 000.15, APE = 003.30 },
                     new AP() { APS = 003.30, APE = 007.1, ALM = 3, ALC = 2 }
            );

            //AC(file, new AP() { APS = 035.50, APE = 048.7 });
        ...
        private void Scene3()
        {
            ...
            Rate = 80;
            //AC(file, new AP() { APS = 000.00, APE = 006.9 });
            //AC(file, new AP() { APS = 030.00, APE = 032.4 });
            //AC(file, new AP() { APS = 038.50, APE = 046.0 });
            //AC(file, new AP() { APS = 055.00, APE = 060.8 });

            AC(file, 
                 new AP() { APS = 000.00, APE = 006.9 },
                 new AP() { APS = 030.00, APE = 032.4 },
                 new AP() { APS = 038.50, APE = 046.0 },
                 new AP() { APS = 055.00, APE = 060.8 }
                );
        }
